...
const TRANSLATIONS = {
  en: {
    ...
    tournament_entry: "Tournament Entry / 赛事登记",
    time_remaining: "Time remaining / 剩余时间",
    register_desc: "Register to join the live tournament bracket. / 登记加入实时对局表。",
    participant_name: "Participant Name / 参赛者姓名",
    enter_full_name: "Enter your full name / 输入您的姓名",
    company_id: "Company ID / 工号/公司ID",
    enter_company_id: "Enter Company ID / 输入工号/公司ID",
    submit_registration: "Submit Registration / 提交登记",
